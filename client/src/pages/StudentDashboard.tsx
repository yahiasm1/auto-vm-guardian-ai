...
const StudentDashboard = () => {
  ...
  const myVms = [
    { id: 'vm1', name: 'CS101-Lab-VM', status: 'running', os: 'Ubuntu 22.04', cpu: 2, ram: 4, storage: 50, course: 'CS101' },
    { id: 'vm2', name: 'DataScience-VM', status: 'stopped', os: 'Ubuntu 20.04', cpu: 4, ram: 8, storage: 100, course: 'DS202' },
  ];
